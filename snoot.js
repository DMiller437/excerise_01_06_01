 ...
 function validateMessage() {
     ...
     try {
         ...
         if(document.getElementById("custom").checked && (msgBox.value === "" || msgBox.value === placeholder)) {
           throw "Please your custom message text.";  
         }else{
             errorDiv.style.display = "none";
             errorDiv.innerHTML = "";
         }
...
//             checking if something is inside the card input box
...
//         loop through the select looking for a blank
           for (var i = 0; i < elementCount; i++) {
             currentElement = selectElements[i];
             //blanks
             if (currentElement.selectedIndex === -1) {
